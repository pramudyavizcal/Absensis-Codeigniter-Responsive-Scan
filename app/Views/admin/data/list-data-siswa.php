               ...
               <tr>
                  ...
                  <td>
                     <div class="d-flex justify-content-center">
                        ...
                        <!-- fungsi untuk pop up preview qr code -->
                        <button title="Preview QR Code" type="button" class="btn btn-info p-2" data-toggle="modal" data-target="#previewQrCodeModal<?= $value['id_siswa']; ?>">
                           <i class="material-icons">visibility</i>
                        </button>
                        <!-- fungsi untuk pop up preview qr code -->
                        <div class="modal fade" id="previewQrCodeModal<?= $value['id_siswa']; ?>" tabindex="-1" role="dialog" aria-labelledby="previewQrCodeModalLabel<?= $value['id_siswa']; ?>" aria-hidden="true">
                           <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                 <div class="modal-header">
                                    <h5 class="modal-title" id="previewQrCodeModalLabel<?= $value['id_siswa']; ?>">Preview QR Code Siswa: <?= $value['nama_siswa']; ?></h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                       <span aria-hidden="true">&times;</span>
                                    </button>
                                 </div>
                                 <div class="modal-body text-center">
                                    <img src="<?= base_url('admin/qr/siswa/' . $value['id_siswa'] . '/preview'); ?>" alt="QR Code Siswa <?= $value['nama_siswa']; ?>">
                                 </div>
                              </div>
                           </div>
                        </div>
