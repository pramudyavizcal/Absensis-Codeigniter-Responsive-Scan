 ...
 <a href="<?= base_url('/admin'); ?> " class="btn btn-primary pl-3">
       ...
       <div class="container-fluid">
          <div class="row mx-auto justify-content-center">
             <div class="col-lg-3 col-xl-4">
                ...
                <!-- menambahkan gambar dari logo sekolah yang sudah diupload dari general settings -->
                 <div class="text-center mt-4">
                    <img src="<?= base_url($generalSettings->logo); ?>" alt="Logo Sekolah" class="img-fluid" style="max-width: 200px;">
                 </div>
             </div>
                      ...
                      <div class="col-10 mx-auto card-header card-header-primary">
                         <div class="row">
                            <div class="col">
                               ...
                               <p class="card-title">Silahkan tunjukkan QR Code anda</p>
                            </div>
                            <div class="col-md-auto">
                               <a href="<?= base_url("scan/$oppBtn"); ?>" class="btn btn-<?= $oppBtn == 'masuk' ? 'success' : 'danger'; ?>">
                                  Absen <?= $oppBtn; ?>
                               </a>
                            </div>
                         </div>
